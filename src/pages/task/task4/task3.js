...
export const TaskFourTaskThree = () => {
                ...
                <div className="flex flex-col items-center ">
                    ...
                    <div className="flex flex-row h-[400] w-[1200px] justify-between mb-[50px]">
                        ...
                        <div
                            ...
                            {data.desc.map((item)=>{
                                return   <p className="italic text-rose-600 text-center align-middle text-2xl mb-[50px]">{parse(`${item}`)}</p>
                            })}
                        ...
                        <div
                            ...
                            <div className="flex flex-col justify-center items-center">
                                    ...
                                    <AnimatePresence>
                                        {
                                            ...
                                            >
                                                {data.solution.map((item)=>{
                                                    return   <p className="italic text-rose-600 text-center align-middle text-xl mb-[50px]">{parse(`${item}`)}</p>
                                                })}
                                ...
                                <div className="flex flex-row h-[150px] w-[580px] justify-center items-center rounded-lg bg-slate-200">
                                    <div className="flex flex-col justify-center items-center">
                                        <div className="h-[80px] w-[120px] flex justify-center items-center">
                                            <AnimatePresence>
                                                {
