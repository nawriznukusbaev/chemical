                                    ...
                                    <AnimatePresence>
                                        {
                                            ...
                                            >
                                                {data.solution.map((item)=>{
                                                    return <p className="italic text-purple-800 text-center text-xl"> {parse(`${item}`)}</p>
                                                }) }
                                    ...
                                    <AnimatePresence>
                                        {
                                            isVisible10&& (<motion.div
                                                ...
                                                transition={{duration: 3}}
                                            >
                                                <p className="italic text-purple-800 text-2xl text-center font-bold">X={parse(`${data.solution1[1].x}`)}</p>
                                                <p className="italic text-purple-800 text-2xl  font-bold">{parse(`${data.solution1[1].e}`)}</p>
                                            </motion.div>)
                                        }
                                    </AnimatePresence>
