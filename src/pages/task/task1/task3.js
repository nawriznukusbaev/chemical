                        ...
                        <div
                            ...
                            <div className="flex flex-col justify-center items-center">
                                <div className="flex flex-row h-[300px] w-[580px] justify-center items-center rounded-lg bg-slate-200">
                                    ...
                                    <div className="flex flex-col justify-center items-center ">
                                        <div className="h-[80px] w-[210px] flex justify-center items-center">
                                            <AnimatePresence>
                                                {
                                    ...
                                    <AnimatePresence>
                                        {
                                            isVisible10 && (<motion.div
                                                ...
                                                transition={{duration: 3}}
                                            >
                                                <p className="italic text-purple-800 m-[25px] font-bold text-2xl"> X=?</p>
