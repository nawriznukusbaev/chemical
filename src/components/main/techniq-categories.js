        ...
        <div className="container-xl flex flex-col">
            <div className="container-xl flex flex-row justify-between">
                <div
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">Смартфони</button>
                </div>
                <div
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">Обогреватели</button>
                </div>
                <div
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">Техника для кухни</button>
                </div>
                <div className="flex flex-row justify-start items-center bg-no-repeat rounded-lg h-[150px] w-[305px] bg-[#3f57b7] mb-[10px]"
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">Бытовая<br/>Техника</button>
                </div>
               </div>
            <div className="container-xl flex flex-row justify-between">
                <div
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">Gaming</button>
                </div>
                <div
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">Авто товары</button>
                </div>
                <div
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">Ноутбуки</button>
                </div>
                <div
                    ...
                    <button type="button" className="p-[20px] pr-[15px] text-white text-lg font-black">TV AUDIO</button>
                </div>
