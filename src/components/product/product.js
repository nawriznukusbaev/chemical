                    ...
                    <div className="flex flex-row w-[45%]">
                        <div className="flex flex-col w-[67px] mr-[50px]">
                            {data.images.map((item)=>{
                                return <button type="button" key={item.image_path} className="border border-current rounded-md p-[1px]"><img src={item.image_path} alt={data.name}/></button>
                            })}
                        </div>
                        <div className="flex flex-col w-[calc(100%-67px)] ">
                            <div className="w-[415px]">
                                <img src={data.images[0].image_path} alt={data.name}/>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-row w-[55%]">
                        <div className="flex flex-col w-[50%] pr-[30px] pb-[30px]">
                            ...
                            <div className="mb-[15px]">
                                ...
                                <div className="flex flex-row">
                                    <button type="button" className="border border-current rounded-md w-[67px] p-[1px]"><img
                                        src={productImage1} alt="color option"/></button>
                                    <button type="button" className="border border-current rounded-md w-[67px] p-[1px]"><img
                                        src={productImage1} alt="color option"/></button>
                                    <button type="button" className="border border-current rounded-md w-[67px] p-[1px]"><img
                                        src={productImage1} alt="color option"/></button>
                            ...
                            <div className="mb-[15px]">
                                ...
                                <div className="flex flex-row">
                                    <button type="button" className="border border-current rounded-md w-[60px] px-[12px] py-[15px]">
